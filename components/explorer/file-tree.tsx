...
function VirtualListRow(props: RowComponentProps<VirtualListRowProps>) {
    const { index, style, flatNodes, fileId, expandedPaths, onToggleExpand, allFileNodes, nodes } = props;
...
export function FileTree({ nodes, fileId }: FileTreeProps) {
    ...
    // Row props for react-window v2 List
